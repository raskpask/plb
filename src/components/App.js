  ...
  constructor(props) {
    ...
    this.state = {
      ...
      swe: {
        ...
        header: {
          listLinks: ["Hem", "Om oss", "Projekt", "Kontakt"],
        },
        footer: {
          info: ["Kontakta oss", "Telefon", "Hitta hit"],
        },
        aboutText: {
          ...
          listValues: [
            "Lösningsinriktat, kundfokuserat och projektfokuserat tjänsteföretag.",
          ...
          listIdea: [
            "Starkt varumärke i branschen med kvalificerade resurser för ledning av mark- och infrastrukturprojekt.",
            "Kundfokuserat tjänsteföretag som arbetar för långsiktiga affärsrelationer.",
          ],

          listSystemTitle: "Verksamhetssystem KMA",
          listSystem: [
            "Långsiktiga affärsrelationer kräver kännedom och kunskap hur rätt kvalitet uppnås. Rätt kvalitet uppnås genom utförande av rätt arbetsuppgifter. Vårt verksamhetssystem hjälper oss i arbetet med att göra rätt arbetsuppgifter och att få långsiktiga affärsrelationer.",
        ...
        projectText: {
          imgText: ["Foto: Sweco/Stockholms stad", "Foto: Stockholms stad"],
          vasagatanTitle: "Projekt Vasagatan",
          vasagatanText:
            "Vasagatan mellan Tegelbacken och Norra Bantorget byggs om för att möta dagens och framtidens behov. Nya Vasagatan blir en välkomnande," +
          ...
          westBridgeText:
            "Västerbron färdigställdes 1935 och består av två broar, bro över Riddarfjärden och bro över Pålsundet.  Projektet omfattar utredning av Västerbrons" +
          ...
          vasaBridgeText:
            "Vasabron färdigställdes 1878 och består av sju stycken bågbroar som sammanbinder Gamla Stan med Norrmalm. Projektet omfattar utredning av Vasabrons " +
            "konstruktiva tillstånd samt framtagande av förslag till åtgärder för att säkra framtida funktion. Projektvolym ca 15 Mkr. Projektledningsbyråns uppdrag är projektledning " +
            "och projekteringsledning. Uppdraget påbörjades 2019 och är pågående.",

          slussenTitle: "Projekt Slussen",
          slussenText:
            "Slussen är efter över 80 år utsliten och byggs därför upp från grunden. Området anpassas för att möta behoven hos dagens och morgondagens stockholmare och" +
      ...
      eng: {
        sigil: {
          title:
            "The seal is issued by UC AB. The image is linked to information about UC's Credit Rating.",
        ...
        header: {
          listLinks: ["Home", "About", "Project", "Contact"],
        },
        footer: {
          info: ["Contact", "Phone", "Find us"],
        },
        aboutText: {
        ...
        projectText: {
          imgText: ["Photo: Sweco/Stockholms stad", "Photo: Stockholms stad"],
          vasagatanTitle: "Vasagatan Project",
          vasagatanText:
            "The central Stockholm street of Vasagatan between Tegelbacken and Norra Bantorget is being rebuilt to meet the needs of today and the future. The new Vasagatan area will be a welcoming, safer and more lively urban street that puts people in the centre. The project volume is approximately SEK 300 million. The task of the project management agency is to undertake project and project design management. The task began in 2019 and is ongoing.",

          westBridgeTitle: "Västerbron Project",
          westBridgeText:
            "Västerbron was completed in 1935 and consists of two bridges, one over the bay of Riddarfjärden and another over the strait of Pålsundet. The project comprises a study into the structural condition of Västerbron and to put forward proposals as to how its functionality can be safeguarded for the future. The project volume is approximately SEK 15 million. The task of the project management agency is to undertake project management and project design management. The task began in 2018 and is ongoing.",

          vasaBridgeTitle: "Vasabron Project",
          vasaBridgeText:
            "Vasabron was completed in 1878 and consists of seven arch bridges which connect the Stockholm island of Gamla Stan to Norrmalm. The project comprises a study into the structural condition of Vasabron and to put forward proposals as to how its functionality can be safeguarded for the future. The project volume is approximately SEK 15 million. The task of the project management agency is to undertake project management and project design management. The task began in 2019 and is ongoing.",
              ...
              {matches.small && (
                <Fragment>
                  <MobileHeader
                    content={
                      this.checkLanguage()
                        ? this.state.swe.header
                        : this.state.eng.header
                    }
                  ...
                  <Routes>
                    <Route
                      ...
                      element={
                        <Home
                          fadeProperties={this.state.fadeProperties}
                          fadeImages={this.state.mobileImages}
                        />
                      }
                    />
                    <Route
                      ...
                      element={
                        <MobileAbout
                          content={
                            this.checkLanguage()
                              ? this.state.swe.aboutText
                              : this.state.eng.aboutText
                          }
                          sigil={
                            this.checkLanguage()
                              ? this.state.swe.sigil
                              : this.state.eng.sigil
                          }
                        />
                      }
                    />
                    <Route
                      ...
                      element={
                        <MobileContact
                          content={
                            this.checkLanguage()
                              ? this.state.swe.contactText
                              : this.state.eng.contactText
                          }
                        />
                      }
                    />
                    <Route
                      ...
                      element={
                        <MobileProject
                          content={
                            this.checkLanguage()
                              ? this.state.swe.projectText
                              : this.state.eng.projectText
                          }
                        />
                      }
                    />
                  ...
                  <MobileFooter
                    content={
                      this.checkLanguage()
                        ? this.state.swe.footer
                        : this.state.eng.footer
                    }
                  />
                </Fragment>
              )}
